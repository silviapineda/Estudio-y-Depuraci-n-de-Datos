# Ejercicio 1.3: Gráficos y Tablas
...
```r
datos<-read.csv("estres_corregido.csv",stringsAsFactors = TRUE)
```
...
2. Haz un gráfico para las variables cualitativas. ¿Están equilibradas las categorías de las variables cualitativas? Ayudate de los gráficos anteriores y haz unas  tablas de frecuencias relativas para contestar.
3. Representa en un gráfico la variable salario por genero y edad por genero, luego haz los estadísticos usando <mark style="color:green;">**`describeBy().`**</mark>**&#x20;¿Quién gana más dinero? ¿quién es más mayor?**
